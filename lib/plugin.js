...
var YuPopup = function YuPopup(option) {
    if (option) {
        //参数合理性判断
        var allowParams = new Set(['type', 'iconType', 'title', 'desc', 'width', 'timing', 'mounted', 'callback']);
